...
const Footer = () => {
  return (
    <div className="bg-no-repeat bg-center min-h-[100vh] flex flex-col justify-between pt-10 px-4 md:px-8 lg:px-16 bg-cover bg-[url('/Footer.png')] text-white">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-20">
        {/* Left Section */}
